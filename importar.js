...
pcBtn.addEventListener("click", function () {
    ...
    pcBtn.style.opacity = "0.5";
    googleFotosBtn.style.opacity = "1";
...
googleFotosBtn.addEventListener("click", function () {
    ...
    googleFotosBtn.style.opacity = "0.5";
...
function errorMsg() {
  ...
  if (albumArray.length === 6) {
      ...
      importarFootBtn.classList.add("disabled");
      Swal.fire({
        icon: "error",
        title: "Erro.",
      ...
      importarFootBtn.classList.remove("disabled");
...
selecaoAlbumBtn.addEventListener("click", function () {
    window.location.href = `selecaoAlbum.html`;
});
...
const importarFootBtn = document.getElementById('importarFootBtn');
importarFootBtn.addEventListener("click", function(event) {
